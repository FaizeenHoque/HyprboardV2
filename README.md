...
> See the renders below for a full picture — the board speaks for itself.

- **MCU**: Raspberry Pi RP2040 (dual-core Arm Cortex-M0+, up to 133MHz)
> ill add more, wait
...
| U2 | Flash | `W25Q16JVSSIQ` | 1 | 16Mbit NOR Flash |
| *(...)* | *(...)* | *(...)* | *(...)* | *(...)* |

> Sourcing links and LCSC part numbers will be added — eventually.
